...
/// </summary>
public sealed class SensorStateChangedEventArgs(Guid providerUid, int sensorNumber, RailSensorState state) : EventArgs
{
    ...
    /// </summary>
    public int SensorNumber { get; } = sensorNumber;

    /// <summary>New state of the sensor.</summary>
    public RailSensorState State { get; } = state;
}
