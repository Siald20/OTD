...
public interface IFeedbackController
{
    ...
    ///     Sensor numbers run from 1 to <see cref="InputCount" />.
    /// </summary>
    int InputCount { get; }
    ...
    /// </summary>
    /// <param name="inputNumber">1-based sensor number (1 .. <see cref="InputCount" />).</param>
    InputState GetInputState(int inputNumber);
    ...
    /// </summary>
    Task<IReadOnlyDictionary<int, InputState>> QueryFeedbackAsync(
